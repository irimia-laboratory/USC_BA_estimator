...
def filename_brainnpy(path_of_mgz, time_split):
    ...
    coordinates_save_path = os.path.join(path_of_mgz, 'coordinates_' + time_split[4] + '-' + str(dic[str(time_split[1])][0]) +
                              '-' +time_split[2] +'_'+time_split[3].split(":")[0] + '-' +
                              time_split[3].split(":")[1] + '-' + time_split[3].split(":")[2] + '.npy')
    coordinates_save_path_csv = os.path.join(path_of_mgz, 'coordinates_' + time_split[4] + '-' + str(dic[str(time_split[1])][0]) +
                              '-' +time_split[2] +'_'+time_split[3].split(":")[0] + '-' +
                              time_split[3].split(":")[1] + '-' + time_split[3].split(":")[2] + '.csv')
    # brain_save_path = os.path.join(path_of_mgz, 'brains_' + time_split[5] + '-' + str(dic[str(time_split[1])][0]) +
    #                           '-' +time_split[3] +'_'+time_split[4].split(":")[0] + '-' +
    #                           time_split[4].split(":")[1] + '-' + time_split[4].split(":")[2] + '.npy')
    # coordinates_save_path = os.path.join(path_of_mgz, 'coordinates_' + time_split[5] + '-' + str(dic[str(time_split[1])][0]) +
    #                           '-' +time_split[3] +'_'+time_split[4].split(":")[0] + '-' +
    #                           time_split[4].split(":")[1] + '-' + time_split[4].split(":")[2] + '.npy')
    # coordinates_save_path_csv = os.path.join(path_of_mgz, 'coordinates_' + time_split[5] + '-' + str(dic[str(time_split[1])][0]) +
    #                           '-' +time_split[3] +'_'+time_split[4].split(":")[0] + '-' +
...
def filename_smap(path_of_mgz, time_split):
    ...
    dic['Nov'] = ['11']
    dic['Dec'] = ['12']
    brain_save_path_1 = os.path.join(path_of_mgz, 'Saliency_maps_' + time_split[4] + '-' + str(dic[str(time_split[1])][0]) +
                              '-' +time_split[2] +'_'+time_split[3].split(":")[0] + '-' +
                              time_split[3].split(":")[1] + '-' + time_split[3].split(":")[2] + '.npy')
    # brain_save_path_1 = os.path.join(path_of_mgz, 'Saliency_maps_' + time_split[5] + '-' + str(dic[str(time_split[1])][0]) +
    #                           '-' +time_split[3] +'_'+time_split[4].split(":")[0] + '-' +
    #                           time_split[4].split(":")[1] + '-' + time_split[4].split(":")[2] + '.npy')
    return brain_save_path_1
